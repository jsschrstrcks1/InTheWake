# legend-of-the-seas — internal-consistency repair
...
`node admin/validate-ship-page.js ships/rcl/legend-of-the-seas.html --json-output | jq '.blocking_errors[] | select(.rule=="internal_numeric_inconsistency")'`
should return empty.
