...
| ajaccio | 54 | 84 PASS | — | You.com (83%) | Removed false tender indicator, Petit Train €12, market hours corrected, FAQ schema synced 6→9, Bastille Day + August closures added, full weather noscript built, 3 weather FAQs added. All noscript fallbacks added. Recent Rail fixed. | **Removed false tender indicator** (most ships dock directly, per You.com + registry). Petit Train 8-10→€12. Market hours corrected (Tue-Sun 7am-1pm, Mon summer only). FAQ schema synced 4→6. Added Bastille Day, August closures, docking note to notices. Needs Yellow Lane weather section build. |
