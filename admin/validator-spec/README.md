...
| [`LOG-002`](rules/LOG-002.md) | Logbook disclosure statement required (## Full disclosure) | warn | S-only | live |
| [`LOG-003`](rules/LOG-003.md) | Logbook 7-section spine includes accessibility and female-crewmate sections | warn | S-only | live |
