...
<!-- RULE-INDEX-START -->
**Total rules:** 91  |  Generated by `scripts/generate-index.cjs`
...
| [`SHIP-005`](rules/SHIP-005.md) | Dining hero image must be the shared Cordelia_Empress_Food_Court.webp | error | V-S-conflict | live |
