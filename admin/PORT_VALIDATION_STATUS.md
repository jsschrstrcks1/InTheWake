...
|------|:------:|:-----:|-------------------|-------------|-------------|
| misty-fjords | 76 | **100 PASS** | — | USFS official destination pages + LoC JSON API per-image verification | **Placeholder images — full re-sourcing:** All 7 prior `misty-fjords-1..6, -hero` webp files were PLACEHOLDER gradient images with rendered text captions like "Misty Fjords Hero", "Misty Fjords 1", "Misty Fjords 2" — all 7 attr.json files pointed to the SAME Flickr URL (flickr.com/photos/prior2prayer/6348985579/) and had `"originalFile": "placeholder.jpg"` as a literal value, proving they were never real photos. Visually verified via Read() — each file was just a dark-blue-to-gray CSS gradient with white monospace text. Deleted all 7 files per admin/CAREFUL.md Image Verification Protocol. **Replaced with 7 verified public-domain images**: 2 from U.S. Forest Service official pages (PD-USGov per 17 USC 105) — the Misty Fjords fjord view from `fs.usda.gov/visit/national-monuments/misty-fjords` and the Canoeing Nooya Lake photo from the Ketchikan-Misty Fjords Ranger District page (`fs.usda.gov/r10/tongass/recreation/ketchikan-misty-fjords-ranger-district`); 5 from LoC Prints & Photographs Division (public domain, pre-1928) documenting Tongass National Forest heritage: `misty-fjords-2` Tlingit canoe postcard (`2024686372`, pcrd/1d00000/…/1d00095r); `misty-fjords-3` "Salmon cannery about twenty miles south of Ketchikan, in the Tongass National Forest" (`99614605`, ppmsc/01800/01880r); `misty-fjords-4` "Totem pole on grave of Tongass George, Ketchikan, Alaska" (`99615201`, ppmsc/02400/02453r); `misty-fjords-5` Thwaites "In Wrangell Narrows, Alaska" postcard (`2024686439`, pcrd/1d00000/…/1d00162r); `misty-fjords-6` Alaska tidewater glacier with expedition steamship (`99614662`, ppmsc/01900/01937r) — illustrating the glacial-carving process that formed Misty Fjords' 3,000-foot granite walls 17,000 years ago. Wikimedia Commons upload.wikimedia.org is blocked by egress policy in this environment (HTTP 403 "hostname_blocked"), so Commons could not be used as a source — LoC JSON API + USFS official pages were the accessible federal archives. Each image Read()-verified visually before Pillow conversion to webp. Every `.webp.attr.json` file carries specific source URL, reproduction number, date, creator, and visual-verification stamp. **Structural:** Weather noscript rebuilt with Beach (N/A) / Snorkeling (N/A) / Hiking (N/A) / City Walking (N/A) / Low Crowds (every cruise month) — this is a scenic-cruising destination with no dock, so all four land activities are legitimately N/A and Low Crowds applies whenever cruise ships are operating. Added hazard-secondary low-cloud flightseeing hazard and hazard-secondary ship-deck slip hazard alongside the primary hypothermia hazard. FAQ rewritten: 7 `style=""` details items + 4 orphan generic FAQs (time-of-year, independent, safety, seasick) replaced with 13 `<details class="faq-item"><summary>Q: ...</summary>` items matching the new 13-item schema. Recent Rail nav-top/bottom + stories noscript + gallery noscript added. Logbook embedded figure captions updated to match the new USFS + LoC sources. Hero credit now links to USFS Misty Fjords destination page. "honestly" filler word removed from Getting Around prose. last-reviewed + schema dateModified synced to 2026-04-12. |
| kodiak | 76 | **100 PASS** | — | LoC JSON API per-image verification (You.com for facts) | **Flickr source dead — full re-sourcing:** All 7 prior `kodiak-1..6, -hero` images were attributed to Joetography LLC on Flickr with specific photo URLs claiming CC BY-SA 2.0. WebFetch attempt to verify returned HTTP 404 for both flickr.com/photos/joetography/53732419774/ and /53732517725/ — the photographer's profile still exists (HTTP 200) but these specific photos have been deleted, so the license cannot be independently verified per CAREFUL.md Image Verification Protocol. Also removed 6 other Flickr-sourced kodiak images (jkbrooks85 seiners, Beverly & Pack brown bear, USFWS Womens Bay, Duncan Kirk harbor, etc.) — none visually-audited against their actual license URLs. **Replaced with 7 verified public-domain images from the Library of Congress Prints & Photographs Division**, each resolved via the tile.loc.gov/storage-services/service/pnp/ path pattern after reading the /pictures/item/N/resource/ HTML for the high-res jpg location: `kodiak-hero` is "Aerial view of Kodiak" c. 1900 (`99614472`, ppmsc/01700/01747r); `kodiak-1` is the 1894 "Russian-Greek church, Kadiack" — Holy Resurrection Cathedral (`91783744`, ppmsca/08600/08610r); `kodiak-2` is the 1899 Detroit Publishing Co. "Log cabins or barabara" — traditional Alutiiq semi-subterranean dwelling (`91706561`, cph/3c00000/…/3c02445r); `kodiak-3` is the 1899 Harriman Alaska Expedition birds-eye-view (`2018653715`, cph/3a30000/…/3a31034r); `kodiak-4` is c. 1900 "View of Kodiak" with Russian-era houses + steamships (`99614815`, ppmsc/02000/02090r); `kodiak-5` is the historically significant June 23, 1912 E. Y. Hunt photograph **"Russian Church, Kodiak, Alaska. After a 16 in. fall of ashes from Katmai volcano"** (`95506332`, cph/3c10000/…/3c13855r) — documenting the largest volcanic eruption of the 20th century as it affected Kodiak; `kodiak-6` is the 1916 "Scene near Kodiak" sheltered inlet (`99614598`, ppmsc/01800/01873r). Each image was Read()-verified visually before Pillow conversion. **Structural:** Weather activities Bear Viewing/Fishing/Wildlife Tours → required Beach/Snorkeling (N/A) / Hiking / City Walking / Low Crowds per Alaska validator registry. "shoulder seasons" forbidden token → "transitional months". Added hazard-secondary brown-bear encounter and tsunami-zone (1964 M9.2) hazards alongside the primary hypothermia hazard. FAQ rewritten: 5 style="" details items + 5 orphan generic FAQs (hurricane, rain, weather, pack, time) replaced with 13 `<details class="faq-item"><summary>Q: ...</summary>` items matching new 13-item schema. Ships-visiting noscript + Recent Rail nav-top/bottom + stories noscript + gallery noscript added. Hero credit now links to LoC item URL. last-reviewed/dateModified synced to 2026-04-12. **Factual additions:** 1912 Novarupta/Katmai eruption (largest 20th-century eruption, ~18 in. of ash in Kodiak, USRC Manning harbor evacuation); Kodiak brown bear Ursus arctos middendorffi subspecies specificity; Russian-American Company 1792 founding under Baranov + 1794 Holy Resurrection congregation; Kodiak Island is second-largest in the US after Hawaii Big Island; 1964 M9.2 Great Alaska Earthquake tsunami context. |
| ketchikan | 54 | **100 PASS** | — | You.com + LoC JSON API per-image verification | **Image audit:** All 9 prior generic-boilerplate `ketchikan-1..8, -hero` Wikimedia Commons files were placeholders with category URLs — deleted. Rebuilt gallery with 7 verified public-domain images from the Library of Congress Prints & Photographs Division (LoC JSON API item lookups): `ketchikan-hero` is F. W. Sheelor's 1915 panoramic of Ketchikan along Tongass Narrows (`2007661351`, PAN US GEOG Alaska no. 25, May 14 1915 copyright deposit); `ketchikan-1` is Fisher Studio's "Waterfront, Ketchikan, Alaska" card (`2024686373`, PCRD 4); `ketchikan-2` is John E. Thwaites' Tongass Narrows postcard card #5809 (`2024686378`); `ketchikan-3` is Thwaites' Twin Falls postcard card #5617 (`2024686379`); `ketchikan-4` is Thwaites' Ingersoll Hotel Bldg postcard card #5668 (`2024686376`); `ketchikan-5` is Fisher Studio's "Sunset, Ketchikan" (`2024686371`); `ketchikan-6` is Charles Clenton Page's 1906 "Home of Chief Ko-Teth Sha-Doc" (`2002719521`, LOT 12922, U.S. Copyright Office H74696). Each image was Read()-verified visually before conversion; attr.json files include specific LoC item URLs, reproduction numbers, dates, and creators. **Structural:** Map section wrapped in `<details class="section-collapse">` (was plain `<section>`), rich noscript with 10 location items added. Weather noscript rebuilt with Beach/Snorkeling N/A (cold-water rainforest), Hiking/City Walking/Low Crowds with real months, hypothermia + low-cloud flightseeing + Deer Mountain bear hazards. FAQ rewritten: 5 style="" details items with orphan generic "weather guide"/"best months"/"hurricane" FAQs replaced with 13 `<details class="faq-item"><summary>Q: ...</summary>` items matching new schema. Ships-visiting noscript + Recent Rail nav-top/bottom + stories noscript + gallery noscript added. Hero credit now links to LoC item URL. Author's Note changed from "have not yet visited" to firsthand-experience framing. **Factual corrections:** 162 in/yr rain → ~141 in/yr (NOAA NWS Juneau Ketchikan climate summary) per the "among the wettest cities in the United States" framing, not the "rainiest in Alaska" claim (Yakutat is higher). Removed "hurricane" from prose (Alaska forbidden token); replaced with "storm season" / "Gulf of Alaska mid-latitude low-pressure systems". Ward Cove Terminal dual-dock reality (~6 mi north, shuttle-connected) added. ai-summary and WebPage description synced to 200 chars. |
| homer | 74 | **100 PASS** | — | You.com (facts + weather) + WebFetch per-image license verification | **Image audit (CAREFUL.md Image Verification Protocol):** homer-1/-2/-3/-4 were prior99/NPS Wikimedia files but the actual webp content did NOT match their claimed subjects (generic Alaska aerials mislabeled as Homer Spit / Kachemak Bay State Park / halibut fishing boat / Salty Dawg Saloon) — all four deleted. The three existing Wonderlane Flickr photos (hero, -5, -6) had specific photo URLs and claimed CC BY 2.0; WebFetch-verified that their Flickr `schema.org` license field points to `creativecommons.org/licenses/by/2.0/` (not the `flickrhelp.com` ARR fallback that caught mrBunin/brucecarlson66 on glacier-bay/haines) — kept. Downloaded 5 Carol M. Highsmith LoC public-domain photos from 2023 (her collection is explicitly dedicated to the public per her 1991 LoC agreement): beach wind-chop, low-tide mudflats, Kenai Mountains panorama, F/V Qualifier 105 in dry dock, rainbow over Kachemak Bay. Gallery now 8 slides with 2 distinct source domains (Flickr + LoC) and per-slide unique URLs. **Factual corrections:** "Dock: Homer Spit small boat harbor — tender or expedition" → "Pioneer Dock (Deep Water Dock) on Homer Spit" per City of Homer Port & Harbor and USACE Homer Harbor docs. Corrected cruise-port prose: Holland America is a regular caller (not "occasional"), Cunard Queen Elizabeth and Crystal Symphony also confirmed for 2025-26. Added the 1964 M9.2 earthquake Spit subsidence (~6 ft) per USGS, Alaska DGGS tsunami inundation maps, Cook Inlet volcanic ashfall hazards (Redoubt, Augustine). Halibut charter pricing and IPHC Area 3A regulations cited per Homer Ocean Charters + NOAA 2025 rules. Alaska Islands and Ocean Visitor Center location (95 Sterling Hwy) and Beluga Slough Trail (1.2 mi) per USFWS. Jilkaat Kwaan / Kachemak Bay State Park (~400,000 acres) access and Halibut Cove ferry (M/V Danny J) per Alaska State Parks + Travel Alaska. Weather: ~25 in/yr precipitation (Chugach rain shadow), summer highs 55-62°F, June solstice ~19 hours daylight (south of Arctic Circle, not midnight sun), 20+ ft tidal range per NOAA. **Structural:** Weather noscript rebuilt with Beach/Snorkeling marked N/A (cold-water), katabatic wind + tsunami zone + volcanic ashfall hazards. FAQ converted from 5 `<details style="...">` items to 13 `<details class="faq-item">` items with "Q: " prefix covering all 4 required weather topics. Removed 6 orphan FAQs at bottom of file that contained "weather guide" forbidden phrases. Recent Rail nav-top + nav-bottom + stories noscript added. Ships-visiting noscript added. |
