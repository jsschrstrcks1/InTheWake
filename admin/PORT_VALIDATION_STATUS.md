...
| akaroa | 64 | 88 PASS | — | You.com (mixed) | Full weather noscript built (temperate maritime, southerly storms). Fixed data-region "Australia"→"New Zealand". Dolphin tour price $150-200→$180-210 NZD. 3 weather FAQs added. FAQ schema synced 4→9. Recent Rail + noscript stories added. | **Removed false tender indicator** (most ships dock directly, per You.com + registry). Petit Train 8-10→€12. Market hours corrected (Tue-Sun 7am-1pm, Mon summer only). FAQ schema synced 4→6. Added Bastille Day, August closures, docking note to notices. Needs Yellow Lane weather section build. |
