# carnival-ecstasy — internal-consistency repair
...
`node admin/validate-ship-page.js ships/carnival/carnival-ecstasy.html --json-output | jq '.blocking_errors[] | select(.rule=="internal_numeric_inconsistency")'`
should return empty.
