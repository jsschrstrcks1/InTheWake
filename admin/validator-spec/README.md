...
<!-- RULE-INDEX-START -->
**Total rules:** 139  |  Generated by `scripts/generate-index.cjs`
...
| ID | Name | Severity | Provenance | Status |
|---|---|---|---|---|
| [`DATA-001`](rules/DATA-001.md) | Port slug canonical across all data sources | error | V+S-agree | live |
| [`DATA-002`](rules/DATA-002.md) | All JSON files must parse without syntax errors | error | V+S-agree | live |
| [`DATA-003`](rules/DATA-003.md) | Ship spec values consistent across HTML sections and JSON data | warn | S-only | live |
...
| ID | Name | Severity | Provenance | Status |
|---|---|---|---|---|
| [`LINK-001`](rules/LINK-001.md) | Ship-page venue references must resolve to existing venue pages | warn | S-only | live |

### LOG (5)

| ID | Name | Severity | Provenance | Status |
|---|---|---|---|---|
| [`LOG-001`](rules/LOG-001.md) | Logbook entry follows 6-movement narrative anatomy | warn | S-only | live |
| [`LOG-002`](rules/LOG-002.md) | Logbook disclosure statement required (## Full disclosure) | warn | V+S-agree | live |
| [`LOG-003`](rules/LOG-003.md) | Logbook 7-section spine includes accessibility and female-crewmate sections | warn | V+S-agree | live |
| [`LOG-004`](rules/LOG-004.md) | Logbook emotional pivot must not be flattened | warn | S-only | live |
| [`LOG-005`](rules/LOG-005.md) | No forbidden brochure/sales language in logbook prose | error | V+S-agree | live |

### MOB (8)

| ID | Name | Severity | Provenance | Status |
|---|---|---|---|---|
| [`MOB-001`](rules/MOB-001.md) | Viewport meta tag present with width=device-width and initial-scale=1 | error | V+S-agree | live |
| [`MOB-002`](rules/MOB-002.md) | No inline widths greater than 480px | warn | V+S-agree | live |
| [`MOB-003`](rules/MOB-003.md) | Hero image container prevents overflow on narrow viewports | warn | V+S-agree | live |
| [`MOB-004`](rules/MOB-004.md) | Wide tables have mobile overflow handling | warn | V+S-agree | live |
| [`MOB-005`](rules/MOB-005.md) | Touch targets meet the 44×44 CSS pixel minimum | warn | V+S-agree | live |
| [`MOB-006`](rules/MOB-006.md) | No elements cause horizontal scroll at narrow viewports | error | V+S-agree | live |
| [`MOB-007`](rules/MOB-007.md) | Minimum font-size 15px across content elements | warn | V+S-agree | live |
| [`MOB-008`](rules/MOB-008.md) | Mobile-hardening CSS section present in shared stylesheet | info | V-only | live |

### NAV (1)

| ID | Name | Severity | Provenance | Status |
|---|---|---|---|---|
| [`NAV-001`](rules/NAV-001.md) | Primary navigation includes the twelve canonical links in order | warn | V+S-agree | live |
...
| ID | Name | Severity | Provenance | Status |
|---|---|---|---|---|
| [`PROOF-001`](rules/PROOF-001.md) | Curly quotes used consistently (no straight quotes in prose) | warn | S-only | live |
| [`PROOF-002`](rules/PROOF-002.md) | Em-dashes used instead of double-hyphens | warn | S-only | live |
| [`PROOF-003`](rules/PROOF-003.md) | No double spaces after periods | warn | S-only | live |
| [`PROOF-004`](rules/PROOF-004.md) | Proper ellipsis character instead of three dots | info | S-only | live |
| [`PROOF-005`](rules/PROOF-005.md) | No placeholder text in published content (Lorem ipsum, TBD, TODO, Coming soon) | error | V+S-agree | live |
...
| ID | Name | Severity | Provenance | Status |
|---|---|---|---|---|
| [`SEC-001`](rules/SEC-001.md) | No eval() in JavaScript | error | V+S-agree | live |
| [`SEC-002`](rules/SEC-002.md) | No debugger statements in production JavaScript | error | V+S-agree | live |
| [`SEC-003`](rules/SEC-003.md) | No console.log in production JavaScript | warn | V+S-agree | live |
| [`SEC-004`](rules/SEC-004.md) | innerHTML assignment requires XSS sanitization review | warn | V+S-agree | live |
| [`SEC-005`](rules/SEC-005.md) | No hardcoded API keys or secrets | error | V+S-agree | live |
| [`SEC-006`](rules/SEC-006.md) | No document.write() in production JavaScript | error | V+S-agree | live |

### SEO (5)

| ID | Name | Severity | Provenance | Status |
|---|---|---|---|---|
| [`SEO-001`](rules/SEO-001.md) | Open Graph meta tags present (og:title, og:description, og:image, og:url) | warn | V+S-agree | live |
| [`SEO-002`](rules/SEO-002.md) | Twitter Card meta tags present (twitter:card, twitter:title, twitter:description) | warn | V+S-agree | live |
| [`SEO-003`](rules/SEO-003.md) | Page title tag present and descriptive | error | V+S-agree | live |
| [`SEO-004`](rules/SEO-004.md) | DOCTYPE declaration present | error | V+S-agree | live |
| [`SEO-005`](rules/SEO-005.md) | No duplicate title tags or meta descriptions | error | V+S-agree | live |
...
| [`VENUE-006`](rules/VENUE-006.md) | venue-tags meta tag present with style / cruise-line / ship-availability attributes | warn | V+S-agree | live |
...
| [`VENUE-010`](rules/VENUE-010.md) | Varies by venue" price placeholder forbidden in key facts | warn | V+S-agree | live |
| [`VENUE-011`](rules/VENUE-011.md) | Coming soon" ship availability placeholder forbidden on active venues | warn | V+S-agree | live |
...
| [`VOI-002`](rules/VOI-002.md) | No hedging stacks in content prose | warn | S-only | live |
| [`VOI-003`](rules/VOI-003.md) | Sentence-length variance must be natural (not mechanical alternation) | warn | S-only | live |
| [`VOI-004`](rules/VOI-004.md) | No interchangeable descriptions (content must be page-specific) | warn | S-only | live |
| [`VOI-005`](rules/VOI-005.md) | Emotional precision — use direct words not euphemisms | warn | S-only | live |
| [`VOI-006`](rules/VOI-006.md) | No road-map paragraphs announcing upcoming content | warn | S-only | live |
| [`VOI-007`](rules/VOI-007.md) | No anaphora ladders or antithetical-parallelism stacks | warn | V+S-agree | live |
