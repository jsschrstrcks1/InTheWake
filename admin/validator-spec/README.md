...
| ID | Name | Severity | Provenance | Status |
|---|---|---|---|---|
| [`SEO-001`](rules/SEO-001.md) | Open Graph meta tags present (og:title, og:description, og:image, og:url) | warn | S-only | live |
| [`SEO-002`](rules/SEO-002.md) | Twitter Card meta tags present (twitter:card, twitter:title, twitter:description) | warn | S-only | live |
...
| [`SEO-005`](rules/SEO-005.md) | No duplicate title tags or meta descriptions | error | S-only | live |
