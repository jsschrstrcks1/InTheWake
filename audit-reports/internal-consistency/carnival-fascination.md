# Internal-consistency repair — Carnival Fascination
...
|---|---|---|
| **2,040** (canonical) | answer-first, ai-summary, JSON-LD ×3, FAQ, fact-block bullet list, stat-item value, prose | Fantasy-class double-occupancy per Carnival |
