...
Quick start
Copy a template from examples/ to your target path.
Replace placeholders: __SHIP_NAME__, __SHIP_SLUG__, __CLASS_NAME__, __VERSION__, etc.
Ensure JSON data files exist at the paths referenced in the template (see comments inside the file).
Commit and push. GitHub Pages will serve with correct canonical, absolute URLs, analytics, and fallbacks.
